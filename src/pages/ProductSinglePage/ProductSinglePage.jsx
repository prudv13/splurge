            ...
            <div className='product-single-r'>
              <div className='product-details font-manrope'>
                ...
                <div className='info flex align-center flex-wrap fs-14'>
                  ...
                  <div className='brand'>
                    <span className='text-yellow fw-5'>Brand:</span>
                    <span className='mx-1'>{product?.brand}</span>
                  </div>
                  <div className='vert-line'></div>
                  <div className='brand'>
                    <span className='text-yellow fw-5'>Category:</span>
                ...
                <div className='price'>
                  <div className='flex align-center'>
                    ...
                    <span className='fs-14 mx-2'>Inclusive of all taxes</span>
                  </div>
                </div>

                <div className='flex align-center my-1'>
                  <div className='new-price fw-5 font-poppins fs-24 text-yellow'>
                  {formatPrice(discountedPrice)}
                  </div>
                  <div className='mx-2 px-2 py-1 discount bg-yellow fs-13 text-white fw-6 font-poppins'>
