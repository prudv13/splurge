          ...
          <div className='cart-chead bg-white'>
            <div className='cart-ctr fw-6 font-manrope fs-15'>
              <div className='cart-cth'>
                <span className='cart-ctxt'>S.No</span>
              </div>
              <div className='cart-cth'>
                ...
                <div className='cart-ctr py-4' key={cart?.id}>
                  ...
                  <div className='cart-ctd'>
                    <div className='qty-change flex align-center'>
                      <button type='button' className='qty-decrease flex align-center justify-center' onClick={() => dispatch(toggleCartQty({id: cart?.id, type: "DESC"}))}>
                  ...
                  <div className='cart-ctd'>
                    <span className='cart-ctxt text-yellow fw-5'>{formatPrice(cart?.totalPrice)}</span>
                  </div>

                  <div className='cart-ctd'>
                    <button type='button' className='delete-btn text-dark' onClick={() => dispatch(removeFromCart(cart?.id))}>
                    <i className="fa-solid fa-trash-can mx-1"></i> <span>Delete</span>
                    </button>
                  </div>
          ...
          <div className='cart-cfoot flex align-start justify-between py-3 bg-white'>
            ...
            <div className='cart-cfoot-r flex flex-column justify-end'>
              <div className='total-txt flex align-center justify-end'>
                ...
                <span className='text-yellow fs-22 mx-2 fw-6'>{formatPrice(totalAmount)}</span>
              </div>

              <button type='button' className='checkout-btn text-white bg-yellow fs-16'>Check Out</button>
            </div>
